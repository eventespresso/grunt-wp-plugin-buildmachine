...
module.exports = {
    ...
    postNewTopic: function (slackInfo, done) {
        var roomInfo = this.getHipChatRoomInfo(slackInfo),
            newTopic = this.getTopicMessage(roomInfo);
        grunt.verbose.writeln(console.log(roomInfo));

        this.slackPostTopic(newTopic);
        this.hipChatPostTopic(roomInfo, newTopic);
