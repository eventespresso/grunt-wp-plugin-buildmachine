...
module.exports = function(grunt) {
	...
	//bumping rc version
	grunt.registerTask( 'bumprc_master', ['setNotifications:init:bumprc:purple', 'gitcheckout:master', 'setNotifications:gitcheckout:master', 'gitpull:master', 'setNotifications:gitpull:master',  'shell:bump_rc', 'setNotifications:shell:bump_rc', 'gitadd:version', 'setNotificationsgitadd:version', 'gitcommit:version', 'setNotifications:gitcommit:version', 'gitpush:bump', 'setNotifications:gitpush:bump', 'setNotifications:end', 'hipchat_notifier:notify_team'] );
	...
	grunt.registerTask( 'bumprc_alpha', ['setNotifications:init:bumprc:purple', 'gitcheckout:alpha', 'setNotifications:gitcheckout:alpha', 'gitpull:alpha', 'setNotifications:gitpull:alpha', 'shell:bump_rc', 'setNotifications:shell:bump_rc', 'gitadd:version', 'setNotificationsgitadd:version', 'gitcommit:version', 'setNotifications:gitcommit:version', 'gitpush:bump_alpha', 'setNotifications:gitpush:bump_alpha', 'setNotifications:end', 'hipchat_notifier:notify_team'] );
	...
	grunt.registerTask( 'bumprc_beta', ['setNotifications:init:bumprc:purple', 'gitcheckout:beta', 'setNotifications:gitcheckout:beta', 'gitpull:beta', 'setNotifications:gitpull:beta', 'shell:bump_rc', 'setNotifications:shell:bump_rc', 'gitadd:version', 'setNotificationsgitadd:version', 'gitcommit:version', 'setNotifications:gitcommit:version', 'gitpush:bump_beta', 'setNotifications:gitpush:bump_beta', 'setNotifications:end', 'hipchat_notifier:notify_team'] );
